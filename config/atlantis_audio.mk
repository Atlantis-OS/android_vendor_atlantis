#
# Atlantis Audio Files
#

ALARM_PATH := vendor/atlantis/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/atlantis/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/atlantis/prebuilt/common/media/audio/ringtones
