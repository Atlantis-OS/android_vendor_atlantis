...
custom_local_manifest = ".repo/local_manifests/atlantis.xml"
custom_default_revision = "fourteen"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'fourteen')
custom_dependencies = "atlantis.dependencies"
org_manifest = "AtlantisOS-Devices"  # leave empty if org is provided in manifest
org_display = "AtlantisOS-Devices"  # needed for displaying
